    ...
    def __init__(self, input_dim, input_len, total_level, current_level, dropout, enc_hidden, output_len, K_IMP):
        ...
        if current_level == 0:
            ...
            self.branch_slelect = nn.Sequential(
                ...
                nn.BatchNorm2d(input_dim, affine=True),
                nn.LeakyReLU(),
...
class IFNet(nn.Module):
    def __init__(self, output_len, input_len, input_dim=9, dec_hidden=1024, num_heads=1):
...
if __name__ == '__main__':
    ...
    model = DPAD_ATT(input_len=168, output_len=args.horizon, input_dim=8, enc_hidden=168,
                     dec_hidden=168, dropout=0.5, num_levels=2, K_IMP=6, RIN=1, num_heads=1).cuda()
